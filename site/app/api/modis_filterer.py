...
lista_bandain=["LC_Type1","LC_Type2","LC_Type3","LC_Type4","LC_Prop1","LC_Prop2","LC_Prop3"]
...
def filter_mcd12q1(data):
    ...
    for subset in data["subset"]:
        if subset["band"] not in lista_bandain:
            continue
        if subset["band"] not in list(filtered_data.keys()):
            filtered_data[subset["band"]] = {
        ...
        filtered_data[subset["band"]]["subset"] = re_scale_mcd12q1(subset["band"],subset["data"])
...
lista_bands_exclu=["FparLai_QC","FparExtra_QC","FparStdDev_500m","LaiStdDev_500m"]
...
def filter_mcd15a2h(data):
    ...
    for subset in data["subset"]:
        ...
        filtered_data[subset["band"]]["subset"] = re_scale(subset["band"],subset["data"])
    return filtered_data
